...
cp js/neural-language-model-transformer.js neural-mr-bot-enhanced/js/neural-language-model.js
cp js/neural-data-manager-enhanced.js neural-mr-bot-enhanced/js/neural-data-manager.js
cp js/app-integrator-enhanced.js neural-mr-bot-enhanced/js/app-integrator.js
...
cp js/neural-conversation-engine.js neural-mr-bot-enhanced/js/
cp js/demo.js neural-mr-bot-enhanced/js/
cp js/test.js neural-mr-bot-enhanced/js/
